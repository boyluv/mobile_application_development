...
(req, res) => {
        ...
        if(lat1 & lat2 & lng1 & lng2)
            ...
            res.send(JSON.stringify({ error: 'Miss param, example : ' + 'https://sheltered-inlet-54201.herokuapp.com/?lat1=10.786471&lat2=10.787907&lng1=106.693645&lng2=106.691903'}));  
        })
